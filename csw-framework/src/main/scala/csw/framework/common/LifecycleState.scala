...
object LifecycleState {
  ...
  /**
   * State of the supervisor/component when started and Supervisor is waiting for the [[FromComponentLifecycleMessage.Initialized]] lifecycle
   ...
   * Component receives the [[ToComponentLifecycleMessage.LifecycleFailureInfo]] message and can take a failure action.
   */
   ...
   * message from the component.
   * Component receives a [[ToComponentLifecycleMessage.Running]] message indicating this.
   ...
   * The component receives the [[ToComponentLifecycleMessage.RunningOffline]] message indicating this change.
   */
