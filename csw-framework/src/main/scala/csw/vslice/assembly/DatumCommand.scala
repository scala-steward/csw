...
//import csw.vslice.assembly.TromboneAssembly.{CommandStart, StopCurrentCommand}
//import csw.vslice.assembly.TromboneStateActor.{SetState, StateWasSet, TromboneState}
