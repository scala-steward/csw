...
import csw.common.commands.matchers.StateMatcher
...
class JCommandService(akkaLocation: AkkaLocation, actorSystem: ActorSystem[_]) {
   ...
   *
   * @param controlCommands the set of [[csw.common.commands.ControlCommand]] payloads
   * @return [[csw.common.commands.CommandResponse.Accepted]] or [[csw.common.commands.CommandResponse.Error]] CommandResponse as a CompletableFuture.
   */
