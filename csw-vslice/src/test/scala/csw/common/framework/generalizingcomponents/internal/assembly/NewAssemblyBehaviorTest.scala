...
import csw.common.framework.generalizingcomponents.api.assembly.{AssemblyFactory, NewAssemblyHandlers}
...
sealed trait AssemblyDomainMessagesNew extends DomainMsgNew
