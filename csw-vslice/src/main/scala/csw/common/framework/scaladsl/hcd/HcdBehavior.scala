...
import csw.common.framework.models.{ComponentResponseMode, DomainMsg, HcdCommandMsg, HcdMsg}
...
class HcdBehavior[Msg <: DomainMsg: ClassTag](ctx: ActorContext[HcdMsg],
                                              ...
                                              hcdHandlers: HcdHandlers[Msg])
    extends ComponentBehavior[Msg, HcdMsg, HcdCommandMsg](ctx, supervisor, hcdHandlers) {

  override def onRunningCompCommandMsg(x: HcdCommandMsg): Unit = x match {
