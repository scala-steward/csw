...
import csw.common.commands.CommandResultType.{Intermediate, Negative, Positive}
 ...
 *
 * @param resultType the nature of command response as [[csw.common.commands.CommandResultType]]
 */
