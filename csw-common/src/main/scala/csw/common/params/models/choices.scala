...
object Choice {
  ...
  private[common] implicit val choiceFormat: OFormat[Choice] = Json.format[Choice]
...
object Choices {
  ...
  private[common] implicit val choicesFormat: OFormat[Choices] = Json.format[Choices]
}
