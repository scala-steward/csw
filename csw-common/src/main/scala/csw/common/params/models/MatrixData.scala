...
import csw.common.params.pb.{ItemType, ItemTypeCompanion}
...
object MatrixData {
  ...
  //play-json formatter
  private[common] implicit def format[T: Format: ClassTag]: Format[MatrixData[T]] = Json.format[MatrixData[T]]
