...
import csw.common.params.models.{Id, ObsId, Prefix}
import csw.common.params.states.StateVariable.StateVariable
 ...
 */
private[common] trait JsonSupport { self: DerivedJsonFormats with WrappedArrayProtocol ⇒
