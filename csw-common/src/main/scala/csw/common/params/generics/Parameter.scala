...
import csw.common.params.pb.{ItemType, ItemsFactory}
...
object Parameter {
  ...
  private[common] implicit def parameterFormat2: Format[Parameter[_]] = new Format[Parameter[_]] {
  ...
  private[common] implicit def parameterFormat[T: Format: ClassTag: ItemsFactory]: Format[Parameter[T]] =
  ...
  private[common] implicit def typeMapper[S: ClassTag: Format: ItemsFactory]: TypeMapper[PbParameter, Parameter[S]] =
  ...
  private[common] implicit val typeMapper2: TypeMapper[PbParameter, Parameter[_]] =
 ...
 */
case class Parameter[S: Format: ClassTag: ItemsFactory] private[common] (
    keyName: String,
    keyType: KeyType[S],
    items: mutable.WrappedArray[S],
    units: Units
