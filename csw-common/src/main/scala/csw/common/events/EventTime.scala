...
import csw.common.params.pb.Implicits.instantMapper
...
object EventTime {
  ...
  private[common] implicit val format: Format[EventTime] = new Format[EventTime] {
  ...
  private[common] implicit val typeMapper: TypeMapper[Timestamp, EventTime] =
