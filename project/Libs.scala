...
object circe {
  val version         = "0.8.0"
  val `circe-core`    = "io.circe" %% "circe-core" % version //Apache License 2.0
  val `circe-generic` = "io.circe" %% "circe-generic" % version //Apache License 2.0
  val `circe-parser`  = "io.circe" %% "circe-parser" % version //Apache License 2.0
}

object Enumeratum {
  val version            = "1.5.12"
  val `enumeratum`       = "com.beachape" %% "enumeratum" % version //MIT License
  val `enumeratum-circe` = "com.beachape" %% "enumeratum-circe" % version
}
