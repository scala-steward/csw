...
object Libs {
  ...
  val `wvlet-log`                    = "org.wvlet"                  %% "wvlet-log"                    % "1.2.3" //Apache License 2.0
  ...
  val `slf4j-jdk14`                  = "org.slf4j"                  % "slf4j-jdk14"                   % "1.7.25" //MIT License
...
//All Akka is Apache License 2.0
object Akka {
  val Version                   = "2.5.1"
...
//All Akka-Http is Apache License 2.0
object AkkaHttp {
  val Version                = "10.0.6"
