...
public class JLocationServiceImplTest implements JLocationServiceLogger {
    ...
    public void testLocationServiceRegisterWithAkkaHttpTcpAsSequence() throws ExecutionException, InterruptedException {
        int port = 8080;
        AkkaRegistration akkaRegistration = JAkkaRegistration.make(akkaHcdConnection, actorRef);
        HttpRegistration httpRegistration = new HttpRegistration(httpServiceConnection, port, Path);
    ...
    public void testResolveAkkaConnection() throws ExecutionException, InterruptedException {
        ...
        AkkaRegistration registration = JAkkaRegistration.make(akkaHcdConnection, actorRef);
    ...
    public void testListComponents() throws ExecutionException, InterruptedException {
        ...
        AkkaRegistration akkaHcdRegistration = JAkkaRegistration.make(akkaHcdConnection, actorRef);
    ...
    public void testListComponentsByComponentType() throws ExecutionException, InterruptedException {
        ...
        AkkaRegistration akkaAssemblyRegistration = JAkkaRegistration.make(akkaHcdConnection, actorRef);
        ...
        AkkaRegistration akkaContainerRegistration = JAkkaRegistration.make(akkaHcdConnection, actorRef);
    ...
    public void testUnregisteringDeadActorByDeathWatch() throws ExecutionException, InterruptedException {
        ...
        Assert.assertEquals(connection, locationService.register(JAkkaRegistration.make(akkaHcdConnection, actorRef)).get().location().connection());

        Thread.sleep(10);

        ArrayList<Location> locations = new ArrayList<>();
        Location location = JAkkaRegistration.make(akkaHcdConnection, actorRef).location(new Networks().hostname());
